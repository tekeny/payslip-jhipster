...
public class Emittor implements Serializable {
    ...
    public User2 getCreatedBy() {
        return createdBy;
    }

    public Emittor createdBy(User2 user2) {
        this.createdBy = user2;
        return this;
    }

    public void setCreatedBy(User2 user2) {
        this.createdBy = user2;
    }

    public User2 getModifiedBy() {
        return modifiedBy;
    }

    public Emittor modifiedBy(User2 user2) {
        this.modifiedBy = user2;
        return this;
    }

    public void setModifiedBy(User2 user2) {
        this.modifiedBy = user2;
    }
