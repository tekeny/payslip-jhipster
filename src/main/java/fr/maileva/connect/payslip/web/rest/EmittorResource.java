...
import fr.maileva.connect.payslip.service.EmittorService;
...
public class EmittorResource {
    ...
    private final EmittorService emittorService;

    public EmittorResource(EmittorService emittorService) {
        this.emittorService = emittorService;
    }
    ...
    public ResponseEntity<Emittor> createEmittor(@Valid @RequestBody Emittor emittor) throws URISyntaxException {
        ...
        Emittor result = emittorService.save(emittor);
    ...
    public ResponseEntity<List<Emittor>> getAllEmittors(Pageable pageable) {
        ...
        Page<Emittor> page = emittorService.findAll(pageable);
    ...
    public ResponseEntity<Emittor> getEmittor(@PathVariable Long id) {
        ...
        Optional<Emittor> emittor = emittorService.findOne(id);
