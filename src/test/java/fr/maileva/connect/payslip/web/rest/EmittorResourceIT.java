...
public class EmittorResourceIT {
    ...
    private static final String DEFAULT_COMPANY_SIRET = "5";
    private static final String UPDATED_COMPANY_SIRET = "7";
    ...
    @Autowired
    private EmittorService emittorService;
    ...
    public void setup() {
        ...
        final EmittorResource emittorResource = new EmittorResource(emittorService);
