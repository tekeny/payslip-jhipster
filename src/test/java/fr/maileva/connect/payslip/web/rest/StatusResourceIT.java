...
public class StatusResourceIT {
    ...
    private static final StatusEnum DEFAULT_CODE = StatusEnum.ENABLE;
    private static final StatusEnum UPDATED_CODE = StatusEnum.DISABLE;
    ...
    public void createStatus() throws Exception {
        ...
        assertThat(testStatus.getDate()).isEqualTo(DEFAULT_DATE);
    }
    ...
    public void updateStatus() throws Exception {
        ...
        assertThat(testStatus.getDate()).isEqualTo(UPDATED_DATE);
    }
